...
{
    static const char *nls_dirs[] = { NULL, DATADIR "/data/data/com.winlator/files/rootfs/wine/nls", "/data/data/com.winlator/files/rootfs/usr/local/share/wine/nls", "/data/data/com.winlator/files/rootfs/usr/share/wine/nls" };
